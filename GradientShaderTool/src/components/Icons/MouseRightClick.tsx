...
interface MouseRightClickProps {
  width?: number;
  height?: number;
  className?: string;
}

export const MouseRightClick: FunctionComponent<MouseRightClickProps> = ({
  width = 18,
  height = 18,
  className = "",
}) => {
  return (
    ...
    >
      <path
        d="M12.5716 5.94307C12.5716 3.2921 10.5249 1.14307 8.00014 1.14307V5.94307H12.5716Z"
        fill="currentColor"
        fill-opacity="0.5"
      />
      <path
